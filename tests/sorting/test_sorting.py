...
def sorting_by_criteria():
    return [
        ...
        {"max_salary": 4545, "min_salary": 21, "date_posted": None},
        ...
        {"max_salary": None, "min_salary": 456, "date_posted": "2011-02-16"},
        {"max_salary": 8723, "min_salary": 1, "date_posted": "2020-01-13"},
        {"max_salary": 33682, "min_salary": 2639, "date_posted": "2011-02-16"},
        {"max_salary": 3457, "min_salary": None, "date_posted": "2011-02-16"},
    ]
...
def test_sort_by_criteria(sorting_by_criteria):
    ...
    for type in sort_types:
        ...
        if type == "min_salary":
            ...
            assert type(result[6]["max_salary"]) is None
        else:
            ...
            assert type(result[6]["date_posted"]) is None
